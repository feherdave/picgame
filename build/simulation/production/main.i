...
inline void LCD_set_cgram_addr(uint8_t);
...
{ 0x04, 0x0A, 0x0A, 0x04, 0x1F, 0x04, 0x0A, 0x11 },
{ 0x0E, 0x15, 0x0A, 0x15, 0x0A, 0x04, 0x04, 0x04 }
};
...
if (gameB_spd < 42000) gameB_spd += 2000;
} else if (trashbin_hit) {
_beep(60, 30);
gameB_difficulty -= 2;
if (gameB_difficulty == 6) {
gameB_difficulty = 16;
if (gameB_spd > 32000) gameB_spd -= 2000;
}
}
