...
# 124
inline void LCDEntryModeSet() {
LCDPutRS0Cmd(LCD.EntryMode);
}

# 133
inline void LCDDisplayControl() {
LCDPutRS0Cmd(LCD.DisplayControl);
}

# 142
inline void LCDSetCGRAMAddress(uint8_t addr) {
LCDPutRS0Cmd(0b01000000 | addr);
}

# 153
void LCDSetCursorPos(uint8_t x, uint8_t y) {
LCDPutRS0Cmd(0b10000000 | (uint8_t) y * 0x40 + x);
}
...
# 251
LCDPutRS0Cmd(0b00100000 | (uint8_t) 0b00001000 | 0b00000000);

# 255
LCDDisplayControl();
LCDPutRS0Cmd(0b00000001);

LCD.EntryMode = 0b00000100 | 0b00000010 | 0b00000000;
LCDEntryModeSet();
